// Auto-generated shim — re-exports from @/lib/ap-physics-1/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _ap_physics_1_Config } from "@/lib/ap-physics-1/config";
import { EXAM_CONFIG as _raw } from "@/lib/ap-physics-1/config";
