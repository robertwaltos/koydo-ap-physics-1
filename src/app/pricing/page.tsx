...
export const metadata: Metadata = {
  title: "Pricing — Ap Physics 1 Premium",
  description: "Unlock unlimited Ap Physics 1 practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=ap-physics-1&cadence=annual`;
